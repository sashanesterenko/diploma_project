...
class Notice(db.Model):
	...
	vendor_definition_method = db.Column(db.Integer, nullable=False)
...
#Способ определения поставщика (подрядчика, исполнителя) - vendor_definition_method
#Организация, осуществляющая размещение - vendor
